...
1. **Unbounded order list retrieval in warehouse home path**
...
1. **Search endpoints use broad `contains` filters over multiple fields**
...
1. **Prisma/PG pooling strategy may stress DB under scale-out**
...
1. **Stub and debug runtime endpoints**
