...
<reference>
@/Users/michele/Dev/NextJS/lemon-wms/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/michele/Dev/NextJS/lemon-wms/.claude/get-shit-done/references/user-profiling.md` to load:
