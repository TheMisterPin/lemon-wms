...
- Usage: Reference from command with `@/Users/michele/Dev/NextJS/lemon-wms/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/michele/Dev/NextJS/lemon-wms/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/michele/Dev/NextJS/lemon-wms/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
