...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/michele/Dev/NextJS/lemon-wms/.codex
                  → checks /Users/michele/Dev/NextJS/lemon-wms/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done
                  → writes to /Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done/hooks/
...
@/Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
