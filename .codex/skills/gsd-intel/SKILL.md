...
Intel system is disabled. To activate:
  ...
  node /Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Users/michele/Dev/NextJS/lemon-wms/.codex/get-shit-done/bin/gsd-tools.cjs
