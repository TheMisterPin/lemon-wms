'use strict';var h=Object.defineProperty;var T=Object.getOwnPropertyDescriptor;var M=Object.getOwnPropertyNames;var j=Object.prototype.hasOwnProperty;var D=(e, t) => {
    for(var n in t){
      h(e, n, { get: t[n], enumerable: !0 })
    }
  }, O=(e, t, n, _) => {
...
}let y=new TextDecoder('utf-8', { ignoreBOM: !0, fatal: !0 });y.decode();const U=2146435072;let S=0
...
function m(e, t){
  return e=e>>>0, R(e, t)
}let f=0;const g=new TextEncoder;'encodeInto'in g||(g.encodeInto=function (e, t){
  const n=g.encode(e)
...
function l(e, t, n){
  if(n===void 0){
    ...
    const i=e.charCodeAt(c);if(i>127){
      break
    }s[r+c]=i
  }if(c!==_){
    c!==0&&(e=e.slice(c)), r=n(r, _, _=c+e.length*3, 1)>>>0;const i=a().subarray(r+c, r+_), d=g.encodeInto(e, i);c+=d.written, r=n(r, _, c, 1)>>>0
  }
...
function I(e){
  const t=typeof e;if(t=='number'||t=='boolean'||e==null){
    return`${e}`
  }if(t=='string'){
    return`"${e}"`
  }if(t=='symbol'){
    ...
    const r=e.length;let s='[';r>0&&(s+=I(e[0]));for(let c=1;c<r;c++){
      s+=', '+I(e[c])
    }

    return s+=']', s
  }const n=/\[object ([^\]]+)\]/.exec(toString.call(e));let _;if(n&&n.length>1){
    _=n[1]
  }else {
...
}const E=typeof FinalizationRegistry>'u'?{ register: () => {}, unregister: () => {} }:new FinalizationRegistry(e => o.__wbg_querycompiler_free(e>>>0, 1));class F{
  __destroy_into_raw(){
    const t=this.__wbg_ptr

    return this.__wbg_ptr=0, E.unregister(this), t
  }free(){
    const t=this.__destroy_into_raw();o.__wbg_querycompiler_free(t, 0)
  }compileBatch(t){
    const n=l(t, o.__wbindgen_malloc, o.__wbindgen_realloc), _=f, r=o.querycompiler_compileBatch(this.__wbg_ptr, n, _);if(r[2]){
      throw w(r[1])
    }

    return w(r[0])
  }constructor(t){
    const n=o.querycompiler_new(t);if(n[2]){
      throw w(n[1])
    }

    return this.__wbg_ptr=n[0]>>>0, E.register(this, this.__wbg_ptr, this), this
  }compile(t){
    const n=l(t, o.__wbindgen_malloc, o.__wbindgen_realloc), _=f, r=o.querycompiler_compile(this.__wbg_ptr, n, _);if(r[2]){
      throw w(r[1])
    }
...
function k(e, t){
  const n=String(t), _=l(n, o.__wbindgen_malloc, o.__wbindgen_realloc), r=f;u().setInt32(e+4*1, r, !0), u().setInt32(e+4*0, _, !0)
}
...
function V(e, t){
  const n=I(t), _=l(n, o.__wbindgen_malloc, o.__wbindgen_realloc), r=f;u().setInt32(e+4*1, r, !0), u().setInt32(e+4*0, _, !0)
}
...
function G(e, t){
  const n=t, _=typeof n==='number'?n:void 0;u().setFloat64(e+8*1, x(_)?0:_, !0), u().setInt32(e+4*0, !x(_), !0)
}

function J(e, t){
  const n=t, _=typeof n==='string'?n:void 0;var r=x(_)?0:l(_, o.__wbindgen_malloc, o.__wbindgen_realloc), s=f;u().setInt32(e+4*1, s, !0), u().setInt32(e+4*0, r, !0)
}
...
function me(){
  const e=o.__wbindgen_externrefs, t=e.grow(4);e.set(0, void 0), e.set(t+0, void 0), e.set(t+1, null), e.set(t+2, !0), e.set(t+3, !1)
