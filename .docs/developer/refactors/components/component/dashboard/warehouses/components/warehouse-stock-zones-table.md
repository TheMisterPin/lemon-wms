...
Reason: Warehouse stock zones table in the locations stock dashboard slice.
Target folder: `src/components/features/locations/components`
Target file name: `warehouse-stock-zones-table.tsx`
...
Table renders warehouse stock zones — align with DTO modules when types relocate.
