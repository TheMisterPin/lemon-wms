...
/**
 * @generated-doc-link
 * @doc .docs/developer/refactors/components/component/media/badge-creation.md
 */
...
export default function BadgeCreation() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 px-4 py-10">
      <div className="w-full max-w-5xl rounded-4xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
        <div className="grid gap-6 lg:grid-cols-[1.35fr_0.95fr]">
          ...
          <aside className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
            ...
            <div className="mt-4 rounded-3xl bg-slate-950 p-5 text-white shadow-sm">
