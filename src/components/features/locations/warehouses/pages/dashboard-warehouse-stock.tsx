...
import { WarehouseStockAvailabilityBarChart } from '../components/warehouse-stock-availability-bar-chart'
import { WarehouseStockItemsTable } from '../components/warehouse-stock-items-table'
import { WarehouseStockSummary } from '../components/warehouse-stock-summary'
import { WarehouseStockZonesTable } from '../components/warehouse-stock-zones-table'
      ...
      <div className="mx-auto max-w-7xl space-y-5">
        <div>
          <div className="text-sm" style={{ color: 'var(--wh-text-muted, #94a3b8)' }}>
            ...
            <Link prefetch={false} href={`/dashboard/locations/warehouses/${data.warehouseId}`} className="hover:underline">
              Overview
            </Link>
            <span className="mx-2">/</span>
            <span>Stock</span>
