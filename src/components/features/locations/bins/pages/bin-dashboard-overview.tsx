...
import { BinOverviewDashboard } from '@/components/features/locations/bins/components/bin-overview-dashboard'
import { BinOverviewDashboardSkeleton } from '@/components/features/locations/bins/skeletons'
