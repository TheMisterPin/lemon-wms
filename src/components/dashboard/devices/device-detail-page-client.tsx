...
import { DeviceDetailDashboard } from '@/components/dashboard/devices/device-detail-dashboard'
import { useDeviceDetailDashboard } from '@/components/dashboard/devices/use-device-detail-dashboard'
