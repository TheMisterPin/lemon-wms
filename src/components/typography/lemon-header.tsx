...
export default function LemonHeader() {
  return (<>
    ...
    <span className="rounded bg-gradient-to-br from-brand-primary to-brand-primary-end px-2 py-0.5 text-xs font-black uppercase tracking-widest text-white">
              WMS
    </span>            <span className="bg-gradient-to-r from-brand-accent via-brand-accent-mid to-brand-accent-end bg-clip-text text-3xl font-black tracking-tight text-transparent">
              LEMON
    </span>
    <span className="rounded bg-gradient-to-br from-brand-primary to-brand-primary-end px-2 py-0.5 text-xs font-black uppercase tracking-widest text-white">
              WMS
