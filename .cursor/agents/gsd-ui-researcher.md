...
Use template from `/Users/michele/Dev/NextJS/lemon-wms/.cursor/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/michele/Dev/NextJS/lemon-wms/.cursor/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/michele/Dev/NextJS/lemon-wms/.cursor/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
