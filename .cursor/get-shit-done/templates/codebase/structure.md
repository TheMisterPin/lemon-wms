...
- Usage: Reference from command with `@/Users/michele/Dev/NextJS/lemon-wms/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/michele/Dev/NextJS/lemon-wms/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/michele/Dev/NextJS/lemon-wms/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
