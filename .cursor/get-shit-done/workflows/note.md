...
- **Global scope**: `/Users/michele/Dev/NextJS/lemon-wms/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/michele/Dev/NextJS/lemon-wms/.cursor/notes/`)
...
2. Glob `/Users/michele/Dev/NextJS/lemon-wms/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/michele/Dev/NextJS/lemon-wms/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/michele/Dev/NextJS/lemon-wms/.cursor/notes/` — works in any directory
